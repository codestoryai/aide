...
import { IInlineCSChatProgressItem, IInlineCSChatEditResponse, IInlineCSChatBulkEditResponse, IInlineCSChatSession, IInlineCSChatRequest, InlineCSChatResponseFeedbackKind } from 'vs/workbench/contrib/inlineCSChat/common/inlineCSChat';
...
export interface MainThreadCSChatProviderShape extends IDisposable {
	...
	$prepareChatAccess(providerId: string): Promise<ICSChatResponseProviderMetadata | undefined>;
...
export type IInlineCSChatResponseDto = Dto<IInlineCSChatEditResponse | Omit<IInlineCSChatBulkEditResponse, 'edits'> & { edits: IWorkspaceEditDto }>;
